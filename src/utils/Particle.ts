...
export class Particle {
  ...
  this.alpha = sketch.map(sketch.noise(this.x * 0.01, this.y * 0.01), 0, 1, 20, 50);
  this.x += this.vx;
  this.y += this.vy;
  }
  ...
  sketch.ellipse(this.x, this.y, this.glowSize + this.size, this.glowSize + this.size);
  ...
  sketch.ellipse(this.x - this.size * 0.15, this.y - this.size * 0.15, this.size * 0.3, this.size * 0.3);
